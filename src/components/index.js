...
export {default as Discount } from './UI/Banner/Discount'
export {default as CardProduct } from './UI/CardProduct/CardProduct'
export {default as CategoryBanner } from './UI/Banner/Category'
export {default as Policy } from './UI/Policy/Policy'
export {default as CartPanel } from './UI/Pannel/CartPanel'
